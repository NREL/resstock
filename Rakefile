...
def copy_other_measures(beopt_measures_dir)
  ...
  other_measures = ["TimeseriesCSVExport", "ResidentialSimulationControls", "ResilienceMetricsReport", "Outages"] # Still under development: "UtilityBillCalculationsSimple", "UtilityBillCalculationsDetailed"
