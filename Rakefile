...
desc 'Perform integrity check on inputs for project_national_beta'
Rake::TestTask.new('integrity_check_national_beta') do |t|
  t.libs << 'test'
  t.test_files = Dir['project_national_beta/tests/*.rb']
  t.warning = false
  t.verbose = true
end # rake task
