...
def create_osws
  ...
  osws_files = {
    ...
    'base-hvac-portable-heater-electric-only.osw' => 'base-single-family-detached.osw',
    ...
    'base-hvac-furnace-gas-plus-air-to-air-heat-pump-cooling.osw' => 'base-single-family-detached.osw',
    ...
    'base-dhw-tank-electric-x2.osw' => 'base-single-family-detached.osw'
  }
...
def get_example_single_family_detached_values(osw_file, step)
  if ['base-single-family-detached.osw'].include? osw_file
    ...
    step.setArgument("supply_duct_leakage_value", 75)
    step.setArgument("return_duct_leakage_value", 25)
    step.setArgument("supply_duct_insulation_r_value", 0)
    step.setArgument("return_duct_insulation_r_value", 0)
    step.setArgument("supply_duct_location", "living space")
    step.setArgument("return_duct_location", "living space")
    step.setArgument("supply_duct_surface_area", 150)
    step.setArgument("return_duct_surface_area", 50)
  ...
  elsif ['base-dhw-tank-electric-x2.osw'].include? osw_file
