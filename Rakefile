...
def get_example_single_family_detached_values(osw_file, step)
  if ['base-single-family-detached.osw'].include? osw_file
    ...
    step.setArgument("crawl_ach", 0.0)
    step.setArgument("attic_type", "unfinished attic")
    step.setArgument("unfinished_attic_sla", 0.00333)
    step.setArgument("unfinished_attic_ceiling_r", 30)
    ...
    step.setArgument("overhangs_distance_to_top_of_window", 0.5)
    ...
    step.setArgument("weather_station_name", "Denver, CO")
    step.setArgument("weather_station_wmo", "725650")
    ...
    step.setArgument("heating_system_heating_efficiency_afue_1", 0.78)
    step.setArgument("heating_system_heating_efficiency_percent_1", 1)
    ...
    step.setArgument("heating_system_heating_efficiency_percent_2", 1)
    ...
    step.setArgument("cooling_system_cooling_efficiency_seer_1", 13.0)
    step.setArgument("cooling_system_cooling_efficiency_eer_1", 8.5)
    ...
    step.setArgument("cooling_system_cooling_efficiency_seer_2", 13.0)
    step.setArgument("cooling_system_cooling_efficiency_eer_2", 8.5)
    ...
    step.setArgument("heat_pump_heating_efficiency_hspf_1", 13.0)
    step.setArgument("heat_pump_cooling_efficiency_seer_1", 7.7)
    step.setArgument("heat_pump_heating_efficiency_cop_1", 3.6)
    step.setArgument("heat_pump_cooling_efficiency_eer_1", 16.6)
    ...
    step.setArgument("heat_pump_heating_efficiency_hspf_2", 13.0)
    step.setArgument("heat_pump_cooling_efficiency_seer_2", 7.7)
    step.setArgument("heat_pump_heating_efficiency_cop_2", 3.6)
    step.setArgument("heat_pump_cooling_efficiency_eer_2", 16.6)
    ...
    step.setArgument("heating_setpoint_temp", Constants.DefaultHeatingSetpoint)
    step.setArgument("cooling_setpoint_temp", Constants.DefaultCoolingSetpoint)
    ...
    step.setArgument("showerbath_low_flow", false)
    ...
    step.setArgument("attic_type", "finished attic")
