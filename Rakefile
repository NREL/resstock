...
def get_example_single_family_detached_values(osw_file, step)
  if ['base-single-family-detached.osw'].include? osw_file
    ...
    step.setArgument("cooling_system_cooling_efficiency_eer_1", -1)
    ...
    step.setArgument("cooling_system_cooling_efficiency_eer_2", -1)
    ...
    step.setArgument("heat_pump_heating_efficiency_cop_1", -1)
    step.setArgument("heat_pump_cooling_efficiency_eer_1", -1)
    ...
    step.setArgument("heat_pump_heating_efficiency_cop_2", -1)
    step.setArgument("heat_pump_cooling_efficiency_eer_2", -1)
