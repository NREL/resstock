...
task :copy_beopt_files do
  ...
  other_measures = ["TimeseriesCSVExport", "ResilienceMetricsReport", "Outages"] # Still under development: "UtilityBillCalculationsSimple", "UtilityBillCalculationsDetailed"
