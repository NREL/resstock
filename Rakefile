...
desc 'Perform integrity check on inputs for project_resstock_heterogeneity'
task :integrity_check_resstock_heterogeneity do
    integrity_check('project_resstock_heterogeneity')
    integrity_check_options_lookup_tsv('project_resstock_heterogeneity')
end # rake task
