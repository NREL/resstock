...
- Add PV ownership and PV system size distributions using 2019 Tracking the Sun and GTM report on solar installation. ([#165](https://github.com/NREL/resstock-estimation/pull/165))
