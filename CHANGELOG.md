...
Features
- Allow air leakage % reduction upgrades (e.g., 25%), and add a new "Infiltration Reduction * Floor Area, Conditioned (Delta ACH50 * ft^2)" cost multiplier for handling incremental costs of such upgrades ([#840](https://github.com/NREL/resstock/pull/840))
