...
- Model a wood storage water heater when "Other Fuel" is sampled from Water Heater Efficiency.tsv. This allows downstream modeling of clothes washer/dryer ([#947](https://github.com/NREL/resstock/pull/947))
