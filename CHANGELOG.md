...
- Synchronize weather between ResStock and ComStock. Increase the number of weather stations from 215 to 941. ([#507](https://github.com/NREL/OpenStudio-BuildStock/pull/507))
