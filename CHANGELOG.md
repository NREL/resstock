...
- New geospatial characteristics have been added or updated. New geospatial characteristics are as follows: ASHRAE IECC Climate Zone 2004, State, County, PUMA, Census Division, Census Region, Building America Climate Zone, and ISO/RTO Region. ([#416](https://github.com/NREL/OpenStudio-BuildStock/pull/416)).
...
- Removed the "Geometry Unit Stories SF" and "Geometry Unit Stories MF" housing characteristics ([#416](https://github.com/NREL/OpenStudio-BuildStock/pull/416)).
