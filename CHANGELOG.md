...
- Allow for plug load energy consumption to vary by Census Division and nclude additional "diversity" multiplier in plug load equations ([#511](https://github.com/NREL/OpenStudio-BuildStock/pull/51))
