...
def er_heating_cost(df):
    ...
    if len(option) != 0:
        ...
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_boiler + c_wiring
...
def water_heating_cost(df):
    ...
    if len(option) != 0:
        ...
        df.loc[(~pd.isnull(df[f'{option_num}_name'])) & (df['build_existing_model.water_heater_fuel'] == 'Electricity'), f'{option_num}_cost_usd'] = c_hpwh50 - c_wiring 
        ...
        df.loc[(~pd.isnull(df[f'{option_num}_name'])) & (df['build_existing_model.water_heater_fuel'] != 'Electricity'), f'{option_num}_cost_usd'] = c_hpwh50
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_lifetime_yrs'] = 13
        df.loc[(~pd.isnull(df[f'{option_num}_name'])) & (df['build_existing_model.water_heater_fuel'] == 'Electricity'), f'{option_num}_cost_usd'] = c_hpwh66 - c_wiring 
        ...
        df.loc[(~pd.isnull(df[f'{option_num}_name'])) & (df['build_existing_model.water_heater_fuel'] != 'Electricity'), f'{option_num}_cost_usd'] = c_hpwh66 
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_lifetime_yrs'] = 13
        df.loc[(~pd.isnull(df[f'{option_num}_name'])) & (df['build_existing_model.water_heater_fuel'] == 'Electricity'), f'{option_num}_cost_usd'] = c_hpwh80 - c_wiring 
        ...
        df.loc[(~pd.isnull(df[f'{option_num}_name'])) & (df['build_existing_model.water_heater_fuel'] != 'Electricity'), f'{option_num}_cost_usd'] = c_hpwh80
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_hpwh_lp50
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_hpwh_lp65
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_hpwh_lp80
...
def cooking_dryer(df):
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_cooking + c_wiring
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_dryer + c_wiring
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_cooking_lp
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_dryer_lp
...
def pool_spa(df):
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_pool + c_wiring
    ...
    if len(option) != 0:
        option_num = option[0][:-5]
        df.loc[~pd.isnull(df[f'{option_num}_name']), f'{option_num}_cost_usd'] = c_spa + c_wiring
