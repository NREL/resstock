...
def create_input_tsv(model, dummy_data_file, tsv_file=None):
    ...
    # df.to_csv(local_dir / "panel_1.csv") # TODO
    ...
    # df.to_csv(local_dir / "panel_2_after_vintage.csv") # TODO
    ...
    # df.to_csv(local_dir / "panel_3_after_cooling_type.csv") # TODO
    ...
    # df.to_csv(local_dir / "panel_4_after_heating_fuel.csv") # TODO
    ...
    df = pd.concat([df, df_new, df_new2], axis=0)

    # df.to_csv(local_dir / "panel_5_after_water_heater_fuel.csv") # TODO
    ...
    if model.model_num != "162":
        ...
        # df.to_csv(local_dir / "panel_6_after_cooking_range.csv") # TODO
    ...
    ## -- save to tsv file --
    if tsv_file is None:
        tsv_file = local_dir / f"Electrical Panel Amp - Model {model.model_num}.tsv"
...
def main(filename=None, predict_proba=False, retain_proba=False, validate_model=False, plot_only=False, sfd_only=False, predict_using_model=False):
    global local_dir, dummy_data_file, data_input_sheetname, data_output_sheetname, output_mapping
    ...
    # Model specs
    model_num = "494" # <--- 162, 494, 1452, 1772
    model_filename, data_input_sheetname, data_output_sheetname, output_mapping = get_model_parameters(model_num)

    model_file = local_dir / "model_20231211" / model_filename
    dummy_data_file = local_dir / "model_20231211" / "model_data_20231211.xlsx"
    tsv_file = local_dir / f"Electrical Panel Amp - Model {model_num}.tsv"
