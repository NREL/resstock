...
def create_distribution_electric_heating(model, dummy_file):
    ...
    csv_file = data_dir / f"electrical_panel_rated_capacity__electric_heating.csv"
...
def create_distribution_nonelectric_heating(model, dummy_file):
    ...
    # save intermediate tsv    
    csv_file = data_dir / f"electrical_panel_rated_capacity__nonelectric_heating.csv"
    df.to_csv(csv_file, index=False)
...
def main():
    ...
    # Model specs
    model_files, dummy_files, output_mapping = get_model_parameters()
