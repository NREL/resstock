...
def get_model_parameters(model):
    ...
    if model == "16574":
        ...
        raise ValueError(f"Unknown model={model}, valid: [16574, 10410, 16570, 90298, 41146, 16566]")
...
def main(
    ...
    data_dir = local_dir / "model_20240312"
    ...
    # Model specs
    model_num = "90298"  # <-- [16574, 10410, 16570 (best), 90298, 41146, 16566]
    (
        model_filename,
