...
def create_input_tsv(
    ...
    if model.model_num == "16574":
        ...
        expected_missing_cols = {}
    elif model.model_num in ["41138", "41906"]:
        input_cols_map = {
            "sqft": "sqft",  # numeric
    ...
    elif model.model_num in ["16570", "90298", "41146"]:
        input_cols_map = {
            "sqft": "sqft",  # numeric
            "Geometry Building Type RECS": "geometry_building_type_recs",
            "HVAC Cooling Type": "hvac_cooling_type",
    ...
    if model.model_num in ["10410", "16570", "90298", "41146"]:
...
def apply_special_mapping(dfi: pd.DataFrame, model_num: str) -> pd.DataFrame:
    if model_num == "16574":
        ...
        if model_num in ["16570", "90298", "41146"]:
            appliance_usage_map = {
                "Electric, 80% Usage": "Electric, 100% Usage",
...
def get_model_parameters(model):
    ...
    if model == "16574":
        ...
        # Original bins, no upsampling of electric heating
        model_filename = "final_panel_model_rank_test_f1_weighted_16566.p"
    elif model == "16570":
        # Original bins, no upsampling of electric heating
        model_filename = "final_panel_model_rank_test_f1_weighted_16570.p"
    elif model == "90298":
        # Original bins, no upsampling of electric heating
        model_filename = "final_panel_model_rank_test_f1_weighted_90298.p"
    elif model == "41146":
        # Original bins, no upsampling of electric heating
        model_filename = "final_panel_model_rank_test_f1_weighted_41146.p"
    elif model == "10410":
        # Original bins, no upsampling of electric heating
        ...
        raise ValueError(f"Unknown model={model}, valid: [16574, 10410, 16570, 90298, 41146, 16566, 41138, 41906]")
