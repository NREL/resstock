...
nec_file = Path("/Users/lliu2/Documents/Lab Call 5A - electrical panel constraints/FY23/Panels Estimation/euss1_2018_results_up00__nec_panels_v1.csv")
pd_file = Path("/Users/lliu2/Documents/Lab Call 5A - electrical panel constraints/FY23/Panels Estimation/euss1_2018_results_up00__predicted_panels_probablistically_assigned.csv")

df = pd.read_csv(nec_file)
dfp = pd.read_csv(pd_file)
