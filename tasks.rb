...
def get_values(osw_file, step)
  ...
  if ['base.osw'].include? osw_file
    ...
    step.setArgument("water_heater_type", "storage water heater")
    step.setArgument("water_heater_fuel_type", "electricity")
    step.setArgument("water_heater_location", "living space")
    ...
    step.setArgument("water_heater_location", "attic - vented")
    ...
    step.setArgument("water_heater_type", "space-heating boiler with tankless coil")
  elsif ['base-dhw-combi-tankless-outside.osw'].include? osw_file
    step.setArgument("heating_system_type", "Boiler")
    step.setArgument("heating_system_electric_auxiliary_energy", 200.0)
    step.setArgument("cooling_system_type", "none")
    step.setArgument("water_heater_type", "space-heating boiler with tankless coil")
    step.setArgument("water_heater_location", "other exterior")
    ...
    step.setArgument("heating_system_electric_auxiliary_energy", 200.0)
    step.setArgument("cooling_system_type", "none")
    step.setArgument("water_heater_type", "space-heating boiler with storage tank")
    ...
    step.setArgument("water_heater_fuel_type", "natural gas")
    step.setArgument("water_heater_tank_volume", 50)
    step.setArgument("water_heater_efficiency", 0.59)
    step.setArgument("water_heater_jacket_rvalue", 10.0)
  elsif ['base-dhw-jacket-hpwh.osw'].include? osw_file
    step.setArgument("water_heater_type", "heat pump water heater")
    ...
    step.setArgument("water_heater_type", "instantaneous water heater")
    ...
    step.setArgument("water_heater_type", "instantaneous water heater")
    step.setArgument("water_heater_fuel_type", "fuel oil")
    step.setArgument("water_heater_efficiency", 0.82)
  elsif ['base-dhw-tankless-propane.osw'].include? osw_file
    step.setArgument("water_heater_type", "instantaneous water heater")
    step.setArgument("water_heater_fuel_type", "propane")
    step.setArgument("water_heater_efficiency", 0.82)
  elsif ['base-dhw-tankless-wood.osw'].include? osw_file
    step.setArgument("water_heater_type", "instantaneous water heater")
    step.setArgument("water_heater_fuel_type", "wood")
    step.setArgument("water_heater_efficiency", 0.82)
    ...
    step.setArgument("water_heater_location", "garage")
