...
class CreateResidentialSingleFamilyDetachedGeometryTest < MiniTest::Test
  ...
  def test_change_garage_pitch_when_garage_ridge_higher_than_house_ridge
    ...
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 26, "ThermalZone" => 4, "Space" => 4, "SpaceType" => 4, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 12 }
  ...
  def test_onestory_fbasement_hasgarage_halfprotrusion_garageright_gableroof
    ...
    args_hash["garage_protrusion"] = 0.5
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 34, "ThermalZone" => 5, "Space" => 5, "SpaceType" => 5, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 12 }
  ...
  def test_onestory_fbasement_hasgarage_fullprotrusion_garageright_gableroof
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 28, "ThermalZone" => 5, "Space" => 5, "SpaceType" => 5, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 12 }
