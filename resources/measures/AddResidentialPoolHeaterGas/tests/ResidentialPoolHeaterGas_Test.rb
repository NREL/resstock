...
class ResidentialPoolHeaterGasTest < MiniTest::Test
  ...
  def test_new_construction_gas
    ...
    _test_measure("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, 0, 1, _scale_energy(222.0, 3, 2000))
  end
  ...
  def test_new_construction_mult_0_014
    ...
    _test_measure("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, 0, 1, _scale_energy(3.108, 3, 2000))
  end
  ...
  def test_new_construction_no_scale_energy
    ...
    _test_measure("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, 0, 1, 222.0)
  end

  def test_retrofit_replace
    args_hash = {}
    args_hash["base_energy"] = 222.0
    model = _test_measure("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, 0, 1, _scale_energy(222.0, 3, 2000))
    args_hash = {}
    args_hash["base_energy"] = 111.0
    _test_measure(model, args_hash, 1, 1, _scale_energy(111.0, 3, 2000))
  end
