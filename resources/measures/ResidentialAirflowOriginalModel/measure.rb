...
#start the measure
class ProcessAirflowOriginalModel < OpenStudio::Ruleset::WorkspaceUserScript
  ...
  def name
    return "Set Residential Airflow - Original Model"
  end
...
ProcessAirflowOriginalModel.new.registerWithApplication