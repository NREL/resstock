...
class ResidentialHotWaterDistribution < OpenStudio::Measure::ModelMeasure
  ...
  def run(model, runner, user_arguments)
    ...
    units.each do |unit|
      ...
      sh_dist_wu_def.additionalProperties.setFeature("dist_hw", shower_dist_hw)
      ...
      s_dist_wu_def.additionalProperties.setFeature("dist_hw", sink_dist_hw)
      ...
      b_dist_wu_def.additionalProperties.setFeature("dist_hw", bath_dist_hw)
