...
class ResidentialHotTubHeaterGasTest < MiniTest::Test
  ...
  def test_new_construction_gas
    ...
    _test_measure(osm_geo_beds, args_hash, 0, 1, _scale_energy(81.0, 3, 2000))
  end
  ...
  def test_new_construction_mult_0_011
    ...
    _test_measure(osm_geo_beds, args_hash, 0, 1, _scale_energy(0.891, 3, 2000))
  end
  ...
  def test_new_construction_no_scale_energy
    ...
    _test_measure(osm_geo_beds, args_hash, 0, 1, 81.0)
  end

  def test_retrofit_replace
    args_hash = {}
    args_hash["base_energy"] = 81.0
    model = _test_measure(osm_geo_beds, args_hash, 0, 1, _scale_energy(81.0, 3, 2000))
    args_hash = {}
