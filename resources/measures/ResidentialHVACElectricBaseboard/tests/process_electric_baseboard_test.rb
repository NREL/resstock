...
class ProcessElectricBaseboardTest < MiniTest::Test
  ...
  def test_retrofit_replace_central_system_boiler_baseboards
    ...
    expected_values = { "Efficiency" => 1 }
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_Central_System_Boiler_Baseboards.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, num_units * 2 + 1)
  end
