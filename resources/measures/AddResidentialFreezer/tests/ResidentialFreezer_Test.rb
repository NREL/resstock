...
class NewMeasureTest < MiniTest::Test
  ...
  def test_new_construction_ef_12
    ...
    _test_new_construction("2000sqft_2story_FB_GRG_UA.osm", args_hash, true, 935.0)
  end
  ...
  def test_new_construction_mult_0_95
    ...
    args_hash["freezer_E"] = 935.0
    args_hash["mult"] = 0.95
    _test_new_construction("2000sqft_2story_FB_GRG_UA.osm", args_hash, true, 888.25)
  end
  ...
  def test_new_construction_mult_1_05
    ...
    args_hash["freezer_E"] = 935.0
    args_hash["mult"] = 1.05
    _test_new_construction("2000sqft_2story_FB_GRG_UA.osm", args_hash, true, 981.75)
  end
  ...
  def test_retrofit_replace
    args_hash = {}
    args_hash["freezer_E"] = 935.0
    model = _test_new_construction("2000sqft_2story_FB_GRG_UA.osm", args_hash, true, 935.0)
    args_hash = {}
    args_hash["freezer_E"] = 417.0
    _test_retrofit(model, args_hash, false, 417.0)
  end
  ...
  def _test_retrofit(model, args_hash, expected_del_object, expected_annual_kwh=nil)
    ...
    if expected_del_object
        ...
        assert_equal(del_object.name.to_s, Constants.ObjectNameFreezer)
