...
class ResidentialGeometryFromFloorspaceJS_Test < MiniTest::Test
  ...
  def test_no_zones_assigned_to_spaces
    ...
    expected_num_new_objects = { "Building" => 1, "Surface" => 40, "Space" => 4, "SpaceType" => 3, "ThermalZone" => 4, "BuildingUnit" => 1, "BuildingStory" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 1, "ExternalFile" => 1, "ScheduleFile" => 1 }
    expected_values = { "Beds" => { "Building Unit 1" => 3 }, "Baths" => { "Building Unit 1" => 2 }, "NumOccupants" => 2.64 }
    model = _test_measure("Denver_Schedules.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_simple_floorplan_unfinished_attic
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Building" => 1, "Surface" => 40, "Space" => 4, "SpaceType" => 3, "ThermalZone" => 3, "BuildingUnit" => 1, "BuildingStory" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 1, "ExternalFile" => 1, "ScheduleFile" => 1 }
    expected_values = { "Beds" => { "Building Unit 1" => 3 }, "Baths" => { "Building Unit 1" => 2 }, "NumOccupants" => 2.64 }
    model = _test_measure("Denver_Schedules.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_simple_floorplan_finished_attic
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Building" => 1, "Surface" => 40, "Space" => 4, "SpaceType" => 2, "ThermalZone" => 2, "BuildingUnit" => 1, "BuildingStory" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 1, "ExternalFile" => 1, "ScheduleFile" => 1 }
    expected_values = { "Beds" => { "Building Unit 1" => 3 }, "Baths" => { "Building Unit 1" => 2 }, "NumOccupants" => 2.64 }
    model = _test_measure("Denver_Schedules.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_single_family_attached
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Building" => 1, "Surface" => 71, "Space" => 8, "SpaceType" => 3, "ThermalZone" => 6, "BuildingUnit" => 2, "BuildingStory" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 1, "ExternalFile" => 1, "ScheduleFile" => 1 }
  ...
  def test_multifamily
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Building" => 1, "Surface" => 24, "Space" => 4, "SpaceType" => 1, "ThermalZone" => 4, "BuildingUnit" => 4, "BuildingStory" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 1, "ExternalFile" => 1, "ScheduleFile" => 1 }
  ...
  def test_mf_with_corridor
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Building" => 1, "Surface" => 92, "Space" => 14, "SpaceType" => 2, "ThermalZone" => 14, "BuildingUnit" => 12, "BuildingStory" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 1, "ExternalFile" => 1, "ScheduleFile" => 1 }
  ...
  def test_mf_multi_zone_floorplan
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Building" => 1, "Surface" => 181, "Space" => 26, "SpaceType" => 6, "ThermalZone" => 22, "BuildingUnit" => 2, "BuildingStory" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 1, "ExternalFile" => 1, "ScheduleFile" => 1 }
    expected_values = { "Beds" => { "Building Unit 1" => 3, "Building Unit 2" => 3 }, "Baths" => { "Building Unit 1" => 2, "Building Unit 2" => 2 }, "NumOccupants" => 6.78 }
    model = _test_measure("Denver_Schedules.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
