...
class ResidentialGeometryFromFloorspaceJS_Test < MiniTest::Test
  ...
  def test_no_zones_assigned_to_spaces
    ...
    expected_values = { "Beds" => { "Building Unit 1" => 3 }, "Baths" => { "Building Unit 1" => 2 }, "NumOccupants" => 3 }
  ...
  def test_single_family_attached
    ...
    expected_values = { "Beds" => { "Building Unit 1" => 3, "Building Unit 2" => 3 }, "Baths" => { "Building Unit 1" => 2, "Building Unit 2" => 2 }, "NumOccupants" => 6 }
    model = _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_multifamily
    ...
    expected_values = { "Beds" => { "Building Unit 1" => 3, "Building Unit 2" => 3, "Building Unit 3" => 3, "Building Unit 4" => 3 }, "Baths" => { "Building Unit 1" => 2, "Building Unit 2" => 2, "Building Unit 3" => 2, "Building Unit 4" => 2 }, "NumOccupants" => 12 }
    model = _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_mf_with_corridor
    ...
    expected_values = { "Beds" => { "Building Unit 1" => 3, "Building Unit 2" => 3, "Building Unit 3" => 3, "Building Unit 4" => 3, "Building Unit 5" => 3, "Building Unit 6" => 3, "Building Unit 7" => 3, "Building Unit 8" => 3, "Building Unit 9" => 3, "Building Unit 10" => 3, "Building Unit 11" => 3, "Building Unit 12" => 3 }, "Baths" => { "Building Unit 1" => 2, "Building Unit 2" => 2, "Building Unit 3" => 2, "Building Unit 4" => 2, "Building Unit 5" => 2, "Building Unit 6" => 2, "Building Unit 7" => 2, "Building Unit 8" => 2, "Building Unit 9" => 2, "Building Unit 10" => 2, "Building Unit 11" => 2, "Building Unit 12" => 2 }, "NumOccupants" => 36 }
    model = _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_mf_with_corridor_bedrooms_assignment
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Building" => 1, "Surface" => 92, "Space" => 14, "SpaceType" => 2, "ThermalZone" => 14, "BuildingUnit" => 12, "BuildingStory" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2 }
    expected_values = { "Beds" => { "Building Unit 1" => 1, "Building Unit 2" => 1, "Building Unit 3" => 2, "Building Unit 4" => 2, "Building Unit 5" => 3, "Building Unit 6" => 3, "Building Unit 7" => 1, "Building Unit 8" => 2, "Building Unit 9" => 3, "Building Unit 10" => 1, "Building Unit 11" => 2, "Building Unit 12" => 3 }, "Baths" => { "Building Unit 1" => 2, "Building Unit 2" => 2, "Building Unit 3" => 2, "Building Unit 4" => 2, "Building Unit 5" => 2, "Building Unit 6" => 2, "Building Unit 7" => 2, "Building Unit 8" => 2, "Building Unit 9" => 2, "Building Unit 10" => 2, "Building Unit 11" => 2, "Building Unit 12" => 2 }, "NumOccupants" => 36 }
    model = _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
