...
class Waterheater
    ...
    def self.apply_tank(model, unit, runner, space, fuel_type, cap, vol, ef, 
        ...
        new_heater = create_new_heater(Constants.ObjectNameWaterHeater(unit.name.to_s), cap, fuel_type, vol, ef, re, set_type, t_set, sch_file, space.thermalZone.get, oncycle_p, offcycle_p, ec_adj, Constants.WaterHeaterTypeTank, 0, tank_model_type, nbeds, model, runner)
    ...
    def self.apply_tankless(model, unit, runner, space, fuel_type, cap, ef, 
        ...
        new_heater = Waterheater.create_new_heater(Constants.ObjectNameWaterHeater(unit.name.to_s), cap, fuel_type, 1, ef, 0, set_type, t_set, sch_file, space.thermalZone.get, oncycle_p, offcycle_p, ec_adj, Constants.WaterHeaterTypeTankless, cd, nbeds, "mixed", model, runner)
