...
class NewMeasureTest < MiniTest::Test
  ...
  def test_new_construction_electric
    ...
    _test_new_construction("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, true, _scale_energy(2300.0, 3, 2000))
  end
  ...
  def test_new_construction_mult_0_004
    ...
    _test_new_construction("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, true, _scale_energy(9.2, 3, 2000))
  end
  ...
  def test_new_construction_no_scale_energy
    ...
    _test_new_construction("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, true, 2300.0)
  end

  def test_retrofit_replace
    args_hash = {}
    args_hash["base_energy"] = 2300.0
    model = _test_new_construction("2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, true, _scale_energy(2300.0, 3, 2000))
    args_hash = {}
