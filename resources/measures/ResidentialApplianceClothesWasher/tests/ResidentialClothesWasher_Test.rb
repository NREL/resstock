...
class ResidentialClothesWasherTest < MiniTest::Test
  ...
  def test_retrofit_replace_with_elec_dryer
    ...
    expected_num_new_objects = { "ElectricEquipmentDefinition" => 2, "ElectricEquipment" => 2, "WaterUseEquipmentDefinition" => 1, "WaterUseEquipment" => 1, "ScheduleFile" => 2, "ScheduleConstant" => 1 }
    expected_values = { "Annual_kwh" => 34.9, "HotWater_gpd" => 2.27, "Location" => args_hash["location"] }
  ...
  def test_retrofit_replace_with_gas_dryer
    ...
    expected_num_new_objects = { "ElectricEquipmentDefinition" => 2, "ElectricEquipment" => 2, "WaterUseEquipmentDefinition" => 1, "WaterUseEquipment" => 1, "ScheduleFile" => 2, "ScheduleConstant" => 1, "OtherEquipmentDefinition" => 1, "OtherEquipment" => 1 }
    expected_values = { "Annual_kwh" => 34.9, "HotWater_gpd" => 2.27, "Location" => args_hash["location"] }
