...
class CreateResidentialSingleFamilyAttachedGeometryTest < MiniTest::Test
  ...
  def test_two_story_fourplex_front_units_gable
    ...
    expected_values = { "FinishedFloorArea" => 900 * 4, "FinishedBasementHeight" => 8, "FinishedBasementFloorArea" => 300 * 4, "UnfinishedAtticHeight" => 7.12, "UnfinishedAtticFloorArea" => 300 * 4, "BuildingHeight" => 8 + 8 + 8 + 7.12, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 12, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
  ...
  def test_ufbasement
    ...
    expected_values = { "FinishedFloorArea" => 900 * 4, "UnfinishedBasementHeight" => 8, "UnfinishedBasementFloorArea" => 900 * 4, "UnfinishedAtticHeight" => 11.61, "UnfinishedAtticFloorArea" => 900 * 4, "BuildingHeight" => 8 + 8 + 11.61, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 12, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_crawl
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 4, "Surface" => 50, "ThermalZone" => 4 + 1 + 1, "Space" => 4 + 1 + 1, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 8 }
    expected_values = { "FinishedFloorArea" => 900 * 4, "CrawlspaceHeight" => 3, "CrawlspaceFloorArea" => 900 * 4, "UnfinishedAtticHeight" => 11.61, "UnfinishedAtticFloorArea" => 900 * 4, "BuildingHeight" => 3 + 8 + 11.61, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 12, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_fourplex_finished_hip_roof
    ...
    expected_values = { "FinishedFloorArea" => 900 * 4, "FinishedAtticHeight" => 9.5, "FinishedAtticFloorArea" => 450 * 4, "BuildingHeight" => 8 + 9.5, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 12, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_fourplex_gable_roof_aspect_ratio_half
    ...
    expected_values = { "FinishedFloorArea" => 900 * 4, "UnfinishedAtticHeight" => 11.61, "UnfinishedAtticFloorArea" => 900 * 4, "BuildingHeight" => 8 + 11.61, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 12, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_fourplex_hip_roof_aspect_ratio_half_offset
    ...
    expected_values = { "FinishedFloorArea" => 900 * 4, "UnfinishedAtticHeight" => 6.30, "UnfinishedAtticFloorArea" => 900 * 4, "BuildingHeight" => 8 + 6.30, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 12, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_argument_error_num_occ_bad_string
    ...
    result = _test_error(nil, args_hash)
    assert_includes(result.errors.map { |x| x.logMessage }, "Number of Occupants must be a number greater than or equal to 0.")
  end
  ...
  def test_minimal_collapsed_front_only
    ...
    expected_values = { "FinishedFloorArea" => 900 * num_finished_spaces, "UnfinishedAtticHeight" => 11.61, "UnfinishedAtticFloorArea" => 900 * num_finished_spaces, "BuildingHeight" => 8 + 11.61, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 9, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_minimal_collapsed_has_rear_units
    ...
    expected_values = { "FinishedFloorArea" => 900 * 6, "FinishedBasementHeight" => 8, "FinishedBasementFloorArea" => 450 * 6, "UnfinishedAtticHeight" => 12.25, "UnfinishedAtticFloorArea" => 450 * 6, "BuildingHeight" => 8 + 8 + 12.25, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 18, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 0 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
