...
<<<<<<< HEAD:resources/measures/ResidentialApplianceCookingRangeElectric/resources/constants.rb
=======
  def self.AirFilm
    return 'AirFilm'
  end
>>>>>>> master:resources/measures/ResidentialApplianceCookingRange/resources/constants.rb
  def self.Auto
    return 'auto'
  end
  def self.ColorWhite
