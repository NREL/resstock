...
<<<<<<< HEAD:resources/measures/ResidentialApplianceClothesDryerFuel/resources/constants.rb
=======
  def self.AirFilm
    return 'AirFilm'
  end
>>>>>>> master:resources/measures/ResidentialConstructionsFinishedBasement/resources/constants.rb
  def self.Auto
    return 'auto'
  end
  def self.ColorWhite
