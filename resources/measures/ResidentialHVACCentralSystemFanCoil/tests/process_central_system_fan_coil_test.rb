...
class ProcessCentralSystemFanCoilTest < MiniTest::Test
  ...
  def test_single_family_attached_fan_coil_heating_and_cooling
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = { "PlantLoop" => 2, "PumpVariableSpeed" => 2, "BoilerHotWater" => 1, "ChillerElectricEIR" => 1, "ControllerWaterCoil" => 4 * num_units, "CoilCoolingWater" => 2 * num_units, "CoilHeatingWater" => 2 * num_units, "FanOnOff" => 2 * num_units, "ZoneHVACFourPipeFanCoil" => 2 * num_units, "SetpointManagerScheduled" => 2, "EnergyManagementSystemSensor" => 2, "EnergyManagementSystemProgram" => 1, "EnergyManagementSystemOutputVariable" => 2, "EnergyManagementSystemProgramCallingManager" => 1 }
    expected_values = {}
