...
class ProcessTwoSpeedCentralAirConditionerTest < MiniTest::Test
  def test_new_construction_seer_16
    ...
    expected_values = { "COP" => [4.3, 3.92], "MaximumSupplyAirTemperature" => 48.88 }
  ...
  def test_new_construction_fbsmt_seer_16_80_dse
    ...
    expected_values = { "COP" => [4.3 * 0.8, 3.92 * 0.8], "NominalCapacity" => [UnitConversions.convert(3.0, "ton", "W")] * 2, "MaximumSupplyAirTemperature" => 48.88 }
  ...
  def test_retrofit_replace_central_system_boiler_baseboards
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = { "AirLoopHVACUnitarySystem" => num_units, "AirLoopHVAC" => num_units, "CoilCoolingDXMultiSpeed" => num_units, "FanOnOff" => num_units, "AirTerminalSingleDuctConstantVolumeNoReheat" => num_units, "CoilCoolingDXMultiSpeedStageData" => 2 * num_units, "UnitarySystemPerformanceMultispeed" => num_units }
