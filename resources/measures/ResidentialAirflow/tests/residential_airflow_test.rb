...
class ResidentialAirflowTest < MiniTest::Test
  ...
  def test_single_family_attached_new_construction_furnace_central_air_conditioner
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0452, 'Cs' => 0.0696, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 49.4 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, \
  ...
  def test_single_family_attached_new_construction_central_system_boiler_baseboards
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0452, 'Cs' => 0.0696, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 49.4 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_multifamily_slab_new_construction_furnace_central_air_conditioner
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.05080, 'Cs' => 0.0535, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 51.3 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_multifamily_cs_new_construction_furnace_central_air_conditioner
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.05080, 'Cs' => 0.0582, 'Cw' => 0.1128, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 51.3 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'crawl zone' }
  ...
  def test_multifamily_ub_new_construction_furnace_central_air_conditioner
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => num_units * 4, 'EnergyManagementSystemSubroutine' => num_units * num_airloops, 'EnergyManagementSystemProgramCallingManager' => num_units * (1 + num_airloops), 'EnergyManagementSystemProgram' => num_units * (2 + num_airloops), 'EnergyManagementSystemSensor' => 3 + (num_units * 27), 'EnergyManagementSystemActuator' => num_units * (5 + 12 * num_airloops), 'EnergyManagementSystemGlobalVariable' => num_units * 23 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => num_units * 2 + 2, 'ZoneMixing' => num_units * 2 * num_airloops, 'OtherEquipment' => num_units * 10 * num_airloops, 'OtherEquipmentDefinition' => num_units * 10 * num_airloops, 'Construction' => 1, 'Surface' => num_units * 6 * num_airloops, 'Space' => num_units * num_airloops, 'ThermalZone' => num_units * num_airloops, 'AirLoopHVACReturnPlenum' => num_units * 2, 'Material' => 1, 'ElectricEquipmentDefinition' => num_units * 3, 'ElectricEquipment' => num_units * 3, 'SurfacePropertyConvectionCoefficients' => num_units * 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.05080, 'Cs' => 0.0535, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 51.3 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished basement zone' }
