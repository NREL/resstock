...
class ResidentialAirflowTest < MiniTest::Test
  ...
  def test_no_hvac_equip
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.07910, 'Cw' => 0.1446, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_has_clothes_dryer
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_neighbors
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000087 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_mech_vent_none
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 1, 'faneff_sp' => 0.471947, 'QWHV' => 0.0 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_mech_vent_cfis
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_sp' => 0.471947, 'QWHV' => 0.0 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_mech_vent_cfis_duct_location_in_living
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.0, 'faneff_sp' => 0.471947, 'QWHV' => 0.0 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_mech_vent_exhaust_ashrae_622
    num_airloops = 2
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
  ...
  def test_crawl
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.098, 'Cw' => 0.1128, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'crawl zone' }
  ...
  def test_pier_beam
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 3, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0959, 'Cw' => 0.1128, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000307 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'pier and beam zone' }
  ...
  def test_ufbasement
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 3, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished basement zone' }
  ...
  def test_fbasement
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 3, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0889, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'finished basement zone' }
  ...
  def test_duct_location_in_living
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_terrain_ocean
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.001317 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Ocean', 'DuctLocation' => 'unfinished attic zone' }
    model, result = _test_measure('SFD_2000sqft_2story_SL_UA_3Beds_2Baths_Denver_Furnace_CentralAC.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, num_airloops, 1)
  end
  ...
  def test_terrain_plains
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000725 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Country', 'DuctLocation' => 'unfinished attic zone' }
    model, result = _test_measure('SFD_2000sqft_2story_SL_UA_3Beds_2Baths_Denver_Furnace_CentralAC.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, num_airloops, 1)
  end
  ...
  def test_terrain_rural
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000487 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Country', 'DuctLocation' => 'unfinished attic zone' }
    model, result = _test_measure('SFD_2000sqft_2story_SL_UA_3Beds_2Baths_Denver_Furnace_CentralAC.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, num_airloops, 1)
  end
  ...
  def test_terrain_city
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000120 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'City', 'DuctLocation' => 'unfinished attic zone' }
    model, result = _test_measure('SFD_2000sqft_2story_SL_UA_3Beds_2Baths_Denver_Furnace_CentralAC.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, num_airloops, 1)
  end
  ...
  def test_mech_vent_hrv
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_sp' => 0.471947, 'QWHV' => 14.8 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone', 'res mv_1 erv' => { 'SupAirRate' => 0.007, 'ExhAirRate' => 0.007, 'Priority' => 1 } }
    model, result = _test_measure('SFD_2000sqft_2story_SL_UA_3Beds_2Baths_Denver_Furnace_CentralAC.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, num_airloops, 1)
    # test objects are removed correctly
    args_hash['mech_vent_type'] = 'none'
    expected_num_del_objects = expected_num_new_objects
  ...
  def test_ducted_mini_split_heat_pump_has_ducts # miniSplitHPIsDucted=true, duct_location=auto
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.07910, 'Cw' => 0.1446, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_ms_htg_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ms_clg_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_ducted_mini_split_heat_pump_cfis
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.07910, 'Cw' => 0.1446, 'faneff_wh' => 0.0, 'faneff_sp' => 0.471947, 'QWHV' => 0.0 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_ms_htg_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ms_clg_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_duct_location_frac
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.099950, 'f_ret' => 0.050049, 'f_OA' => 0.049900 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.099950, 'f_ret' => 0.050049, 'f_OA' => 0.049900 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
    model, result = _test_measure('SFD_2000sqft_2story_SL_UA_3Beds_2Baths_Denver_Furnace_CentralAC.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, num_airloops, 1)
  end
  ...
  def test_return_loss_greater_than_supply_loss
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.030119, 'f_ret' => 0.194880, 'f_OA' => 0.164760 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.030119, 'f_ret' => 0.194880, 'f_OA' => 0.164760 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
    model, result = _test_measure('SFD_2000sqft_2story_SL_UA_3Beds_2Baths_Denver_Furnace_CentralAC.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, num_airloops, 1)
  end
  ...
  def test_no_living_garage_attic_infiltration
    ...
    expected_values = { 'res_infil_1_program' => { 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 90.1 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_garage_without_attic
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0536, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 51.5 }, 'res_nv_1_program' => { 'Cs' => 0.000229, 'Cw' => 0.000319 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'garage zone' }
  ...
  def test_retrofit_infiltration
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0323, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_sp' => 0.471947, 'QWHV' => 57.8 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.149925, 'f_ret' => 0.075074, 'f_OA' => 0.074850 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished attic zone' }
  ...
  def test_retrofit_duct_location_in_living
    num_airloops = 2
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemSubroutine' => num_airloops, 'EnergyManagementSystemProgramCallingManager' => 1 + num_airloops, 'EnergyManagementSystemProgram' => 2 + num_airloops, 'EnergyManagementSystemSensor' => 10 + 10 * num_airloops, 'EnergyManagementSystemActuator' => 5 + 12 * num_airloops, 'EnergyManagementSystemGlobalVariable' => 23 * num_airloops, 'AirLoopHVACReturnPlenum' => num_airloops, 'OtherEquipmentDefinition' => 10 * num_airloops, 'OtherEquipment' => 10 * num_airloops, 'ThermalZone' => num_airloops, 'ZoneMixing' => 2 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Space' => num_airloops, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3, 'SurfacePropertyConvectionCoefficients' => 6 * num_airloops, 'Surface' => 6 * num_airloops }
    ...
    expected_num_del_objects = expected_num_new_objects
    expected_num_new_objects = { 'ScheduleRuleset' => 4, 'EnergyManagementSystemProgramCallingManager' => 1, 'EnergyManagementSystemProgram' => 2, 'EnergyManagementSystemSensor' => 12, 'EnergyManagementSystemActuator' => 5, 'SpaceInfiltrationDesignFlowRate' => 2, 'SpaceInfiltrationEffectiveLeakageArea' => 1, 'Construction' => 1, 'Material' => 1, 'ElectricEquipmentDefinition' => 3, 'ElectricEquipment' => 3 }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0753, 'Cs' => 0.0906, 'Cw' => 0.1323, 'faneff_sp' => 0.471947, 'QWHV' => 27.3 }, 'res_nv_1_program' => { 'Cs' => 0.000179, 'Cw' => 0.000282 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_single_family_attached_new_construction_furnace_central_air_conditioner
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0452, 'Cs' => 0.0696, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 39.0 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, \
  ...
  def test_single_family_attached_new_construction_central_system_boiler_baseboards
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.0452, 'Cs' => 0.0696, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 39.0 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_multifamily_slab_new_construction_furnace_central_air_conditioner
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.05080, 'Cs' => 0.0535, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 35.8 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'TerrainType' => 'Suburbs' }
  ...
  def test_multifamily_cs_new_construction_furnace_central_air_conditioner
    ...
    expected_values = { 'res_infil_1_program' => { 'c' => 0.05080, 'Cs' => 0.0582, 'Cw' => 0.1128, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 35.8 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0.099800 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'crawl zone' }
  ...
  def test_multifamily_ub_new_construction_furnace_central_air_conditioner
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { 'ScheduleRuleset' => num_units * 4, 'EnergyManagementSystemSubroutine' => num_units * num_airloops, 'EnergyManagementSystemProgramCallingManager' => num_units * (1 + num_airloops), 'EnergyManagementSystemProgram' => num_units * (2 + num_airloops), 'EnergyManagementSystemSensor' => 3 + (num_units * 27), 'EnergyManagementSystemActuator' => num_units * (5 + 12 * num_airloops), 'EnergyManagementSystemGlobalVariable' => num_units * 23 * num_airloops, 'SpaceInfiltrationDesignFlowRate' => num_units * 2 + 2, 'ZoneMixing' => num_units * 2 * num_airloops, 'OtherEquipment' => num_units * 10 * num_airloops, 'OtherEquipmentDefinition' => num_units * 10 * num_airloops, 'Construction' => 1, 'Surface' => num_units * 6 * num_airloops, 'Space' => num_units * num_airloops, 'ThermalZone' => num_units * num_airloops, 'AirLoopHVACReturnPlenum' => num_units * 2, 'Material' => 1, 'ElectricEquipmentDefinition' => num_units * 3, 'ElectricEquipment' => num_units * 3, 'SurfacePropertyConvectionCoefficients' => num_units * 6 * num_airloops }
    expected_values = { 'res_infil_1_program' => { 'c' => 0.05080, 'Cs' => 0.0535, 'Cw' => 0.1323, 'faneff_wh' => 0.943894, 'faneff_sp' => 0.471947, 'QWHV' => 35.8 }, 'res_nv_1_program' => { 'Cs' => 0.000089, 'Cw' => 0.000199 }, 'res_ds_res_fur_gas_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0 }, 'res_ds_res_ac_asys_lk_subrout' => { 'f_sup' => 0.199900, 'f_ret' => 0.100099, 'f_OA' => 0 }, 'TerrainType' => 'Suburbs', 'DuctLocation' => 'unfinished basement zone' }
      ...
      new_objects.each do |new_object|
        ...
        if ['EnergyManagementSystemProgram', 'EnergyManagementSystemSubroutine'].include? obj_type
          new_object.lines.each do |line|
            ...
            if rhs.include? 'res_infil_1_wh_sch_s*'
              rhs = rhs.gsub('res_infil_1_wh_sch_s*', '')
              rhs = UnitConversions.convert(Float(rhs), 'm^3/s', 'cfm')
            end
