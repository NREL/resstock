...
class ResidentialGeometryCreateSingleUnitTest < Minitest::Test
  # def setup
  # end
  ...
  def test_bottom_left_rearunits
  ...
  def test_number_of_arguments_and_argument_names
    ...
    measure = ResidentialGeometryCreateSingleUnit.new
