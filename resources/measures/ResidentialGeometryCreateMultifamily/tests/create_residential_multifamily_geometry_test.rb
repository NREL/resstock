...
class CreateResidentialMultifamilyGeometryTest < MiniTest::Test
  ...
  def test_uneven_units_per_floor_with_interior_corr
    ...
    expected_num_new_objects = { "BuildingUnit" => 3, "Surface" => 26, "ThermalZone" => 1 + 3, "Space" => 1 + 3, "SpaceType" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 11, "BuildingStory" => 1 }
  ...
  def test_warning_balc_but_no_inset
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 2, "Surface" => 12, "ThermalZone" => 2, "Space" => 2, "SpaceType" => 1, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 8, "BuildingStory" => 1 }
  ...
  def test_two_story_double_exterior
    ...
    args_hash["balcony_depth"] = 6
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 2 * 4, "Surface" => 68, "ThermalZone" => 2 * 4, "Space" => 2 * 4, "SpaceType" => 1, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 14, "ShadingSurface" => 30, "BuildingStory" => 2 }
  ...
  def test_multiplex_right_inset
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 8 * 6, "Surface" => 538, "ThermalZone" => 8 * 6 + 1 + 1, "Space" => 8 * 6 + 1 + 8, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 26, "BuildingStory" => 9 }
  ...
  def test_multiplex_left_inset
    ...
    args_hash["foundation_type"] = "unfinished basement"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 8 * 6, "Surface" => 538, "ThermalZone" => 8 * 6 + 1 + 1, "Space" => 8 * 6 + 1 + 8, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 50, "ShadingSurface" => 74, "BuildingStory" => 9 }
    expected_values = { "FinishedFloorArea" => 900 * 8 * 6, "UnfinishedBasementHeight" => 8, "UnfinishedBasementFloorArea" => 6 * 900 + 3 * 21.77 * 10, "BuildingHeight" => 8 + 8 * 8, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 162.72, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 112 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_crawl_single_exterior
    ...
    args_hash["foundation_type"] = "crawlspace"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 2 * 12, "Surface" => 194, "ThermalZone" => 2 * 12 + 1, "Space" => 2 * 12 + 1, "SpaceType" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 4, "ShadingSurface" => 30, "BuildingStory" => 3 }
  ...
  def test_crawlspace_double_loaded_corr
    ...
    args_hash["foundation_type"] = "crawlspace"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1 * 4, "Surface" => 52, "ThermalZone" => 1 * 4 + 1 + 1, "Space" => 1 * 4 + 1 + 1, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 12, "BuildingStory" => 2 }
  ...
  def test_one_unit_per_floor_with_rear_units
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 2, "Surface" => 12, "ThermalZone" => 2, "Space" => 2, "SpaceType" => 1, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 4, "ShadingSurface" => 8, "BuildingStory" => 2 }
  ...
  def test_two_units_per_floor_with_rear_units
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 8, "Surface" => 72, "ThermalZone" => 8 + 1, "Space" => 12, "SpaceType" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 10, "BuildingStory" => 4 }
  ...
  def test_one_unit_per_floor_with_no_rear_units
    ...
    args_hash["corridor_position"] = "None"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 4, "Surface" => 24, "ThermalZone" => 4, "Space" => 4, "SpaceType" => 1, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 6, "BuildingStory" => 4 }
  ...
  def test_odd_units_per_floor_double_exterior
    ...
    args_hash["corridor_position"] = "Double Exterior"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => num_finished_spaces, "Surface" => 60, "ThermalZone" => num_finished_spaces, "Space" => num_finished_spaces, "SpaceType" => 1, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 6, "ShadingSurface" => 16, "BuildingStory" => 2 }
  ...
  def test_new_construction_none
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Surface" => 18, "Space" => 3, "SpaceType" => 2, "ThermalZone" => 3, "BuildingUnit" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 10, "BuildingStory" => 1 }
  ...
  def test_new_construction_auto
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Surface" => 18, "Space" => 3, "SpaceType" => 2, "ThermalZone" => 3, "BuildingUnit" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 10, "BuildingStory" => 1 }
  ...
  def test_minimal_collapsed_large_building
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Surface" => 138, "Space" => num_finished_spaces + 3, "SpaceType" => 2, "ThermalZone" => num_finished_spaces + 1, "BuildingUnit" => num_finished_spaces, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 14, "BuildingStory" => 3 }
  ...
  def test_minimal_collapsed_medium_building
    ...
    args_hash["minimal_collapsed"] = "true"
    expected_num_del_objects = {}
    expected_num_new_objects = { "Surface" => 92, "Space" => num_finished_spaces + 2, "SpaceType" => 2, "ThermalZone" => num_finished_spaces + 1, "BuildingUnit" => num_finished_spaces, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 14, "BuildingStory" => 2 }
  ...
  def test_minimal_collapsed_small_building
    ...
    args_hash["minimal_collapsed"] = "true"
    expected_num_del_objects = {}
    expected_num_new_objects = { "Surface" => 18, "Space" => num_finished_spaces, "SpaceType" => 1, "ThermalZone" => num_finished_spaces, "BuildingUnit" => num_finished_spaces, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 3, "ShadingSurface" => 11, "BuildingStory" => 1 }
  ...
  def test_has_first_floor_commercial_space
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Surface" => 164, "Space" => num_finished_spaces, "SpaceType" => 3, "ThermalZone" => num_finished_spaces - 2, "BuildingUnit" => num_finished_spaces - 4, "PeopleDefinition" => num_finished_spaces - 4, "People" => num_finished_spaces - 4, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 14, "BuildingStory" => 4 }
