...
class CreateResidentialMultifamilyGeometryTest < MiniTest::Test
  ...
  def test_multiplex_right_inset
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 26, "ThermalZone" => 1 + 1 + 1, "Space" => 1 + 1 + 1, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 1, "ShadingSurface" => 1 }
    expected_values = { "FinishedFloorArea" => 900, "UnfinishedBasementHeight" => 8, "UnfinishedBasementFloorArea" => 900 + 0.5 * 21.77 * 10, "BuildingHeight" => 8 + 8, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 3.39, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 13 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_multiplex_left_inset_balcony
    ...
    args_hash["foundation_type"] = "unfinished basement"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 26, "ThermalZone" => 1 + 1 + 1, "Space" => 1 + 1 + 1, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 2 }
    expected_values = { "FinishedFloorArea" => 900, "UnfinishedBasementHeight" => 8, "UnfinishedBasementFloorArea" => 900 + 0.5 * 21.77 * 10, "BuildingHeight" => 8 + 8, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 3.39, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 12 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_bot_ufbasement_double_loaded_corr
    ...
    args_hash["foundation_type"] = "unfinished basement"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 22, "ThermalZone" => 1 + 1 + 1, "Space" => 1 + 1 + 1, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 7 }
    expected_values = { "FinishedFloorArea" => 900 * 1, "UnfinishedBasementHeight" => 8, "UnfinishedBasementFloorArea" => 900 + 0.5 * 21.21 * 10, "BuildingHeight" => 8 + 8, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 3.39, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 10 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_top_ufbasement_double_loaded_corr
    ...
    args_hash["level"] = "Top"
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 12, "ThermalZone" => 1 + 1, "Space" => 1 + 1, "SpaceType" => 2, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 7 }
  ...
  def test_bot_crawl_double_loaded_corr
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "BuildingUnit" => 1, "Surface" => 22, "ThermalZone" => 1 + 1 + 1, "Space" => 1 + 1 + 1, "SpaceType" => 3, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 7 }
    expected_values = { "FinishedFloorArea" => 900 * 1, "CrawlspaceHeight" => 3, "CrawlspaceFloorArea" => 900 + 0.5 * 21.21 * 10, "BuildingHeight" => 3 + 8, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 3.39, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 10 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_new_construction_none
    ...
    expected_values = { "FinishedFloorArea" => 900 * num_finished_spaces, "BuildingHeight" => 8, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 0, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 4 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_new_construction_fixed_3
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = { "Surface" => 12, "Space" => 2, "SpaceType" => 2, "ThermalZone" => 2, "BuildingUnit" => 1, "PeopleDefinition" => num_finished_spaces, "People" => num_finished_spaces, "ScheduleRuleset" => 2, "ShadingSurfaceGroup" => 2, "ShadingSurface" => 8 }
    expected_values = { "FinishedFloorArea" => 900 * 1, "BuildingHeight" => 8, "Beds" => 3.0, "Baths" => 2.0, "NumOccupants" => 3 * 1, "EavesDepth" => 2, "NumAdiabaticSurfaces" => 4 }
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
