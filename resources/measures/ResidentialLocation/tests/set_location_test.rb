...
class SetResidentialEPWFileTest < MiniTest::Test
  ...
  def test_NA_daylight_saving
    ...
    expected_values = { 'HotWaterAnnualTemp' => 10.88, 'HotWaterMaxDiffTemp' => 23.15, 'IECCZone' => '' }
  ...
  def test_change_daylight_saving
    ...
    expected_values = { 'StartDate' => 'Mar-12', 'EndDate' => 'Nov-05', 'HotWaterAnnualTemp' => 10.88, 'HotWaterMaxDiffTemp' => 23.15, 'IECCZone' => '' }
    ...
    expected_values = { 'StartDate' => 'Apr-08', 'EndDate' => 'Oct-27', 'HotWaterAnnualTemp' => 10.88, 'HotWaterMaxDiffTemp' => 23.15, 'IECCZone' => '' }
    ...
    all_new_objects.each do |obj_type, new_objects|
      new_objects.each do |new_object|
        ...
        if obj_type == 'RunPeriodControlDaylightSavingTime'
          ...
          assert(climate_zones[0].value.include?(expected_values['IECCZone']))
        end
      end
    end
