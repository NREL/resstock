...
<<<<<<< HEAD:resources/measures/ResidentialApplianceCookingRangeFuel/resources/constants.rb
=======
  def self.AirFilm
    return 'AirFilm'
  end
>>>>>>> master:resources/measures/ResidentialConstructionsCrawlspace/resources/constants.rb
  def self.Auto
    return 'auto'
  end
  def self.ColorWhite
