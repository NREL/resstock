...
class ResidentialExtraRefrigerator < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
    ...
    space.setDescription("Select the space where the extra refrigerator is located. '#{Constants.Default}' will choose the lowest above-grade finished space available (e.g., first story living space), or a below-grade finished space as last resort. For multifamily buildings, '#{Constants.Default}' will choose a space for each unit of the building.")
