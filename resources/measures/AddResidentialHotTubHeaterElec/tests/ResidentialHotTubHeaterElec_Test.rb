...
class ResidentialHotTubHeaterElecTest < MiniTest::Test
  ...
  def test_new_construction_electric
    ...
    _test_measure(osm_geo_beds, args_hash, 0, 1, _scale_energy(1027.3, 3, 2000))
  end
  ...
  def test_new_construction_mult_0_048
    ...
    _test_measure(osm_geo_beds, args_hash, 0, 1, _scale_energy(49.3104, 3, 2000))
  end
  ...
  def test_retrofit_replace
    args_hash = {}
    args_hash["base_energy"] = 1027.3
    model = _test_measure(osm_geo_beds, args_hash, 0, 1, _scale_energy(1027.3, 3, 2000))
    args_hash = {}
