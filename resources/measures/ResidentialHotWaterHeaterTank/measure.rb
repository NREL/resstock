...
class ResidentialHotWaterHeaterTank < OpenStudio::Measure::ModelMeasure
    ...
    def arguments(model)
        ...
        #make a string argument for mixed or startified tank
        tank_model_type_display_name = OpenStudio::StringVector.new
        tank_model_type_display_name << "Mixed"
        tank_model_type_display_name << "Stratified"
        ...
        tank_model_type.setDescription("Type of tank model to use. Stratified tanks generally provide more accurate results, but may significantly increase run time.")
        tank_model_type.setDefaultValue("Mixed")
