...
def process_utility_rate_csv(filepath)
  # process any csv generated by nrgx.openei using openei
  require_relative 'ReportUtilityBills/resources/util'
...
if ARGV.size == 0
  ...
  exit!
elsif ARGV[0].to_sym == :process_utility_rate_csv && ARGV.size != 2
  puts 'ERROR: Wrong commands.'
  display_usage(command_list)
  exit!
elsif ARGV[0].to_sym != :process_utility_rate_csv && ARGV.size > 1
...
if ARGV[0].to_sym == :process_utility_rate_csv
  process_utility_rate_csv(ARGV[1])
end
