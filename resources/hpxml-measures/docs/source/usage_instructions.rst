...
#. Download `OpenStudio 3.6.0 <https://github.com/NREL/OpenStudio/releases/tag/v3.6.0>`_ and install the Command Line Interface/EnergyPlus/C++ API components, or use the `nrel/openstudio docker image <https://hub.docker.com/r/nrel/openstudio>`_.
