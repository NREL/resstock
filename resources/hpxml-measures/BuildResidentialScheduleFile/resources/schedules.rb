...
class ScheduleGenerator
  ...
  def create_stochastic_schedules(args:,
    ...
    @schedules[SchedulesFile::Columns[:CookingRange].name] = cooking_power_sch.map { |power| power }
    ...
    @schedules[SchedulesFile::Columns[:ClothesWasher].name] = cw_power_sch.map { |power| power }
    ...
    @schedules[SchedulesFile::Columns[:ClothesDryer].name] = cd_power_sch.map { |power| power }
    ...
    @schedules[SchedulesFile::Columns[:Dishwasher].name] = dw_power_sch.map { |power| power }
