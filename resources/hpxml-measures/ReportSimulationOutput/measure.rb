...
class ReportSimulationOutput < OpenStudio::Measure::ReportingMeasure
  ...
  def setup_outputs(called_from_outputs_method, user_output_variables = nil)
    ...
    @component_loads[[LT::Heating, CLT::WindowsTransmitted]] = ComponentLoad.new(ems_variable: 'loads_htg_windows_transmitted')
    @component_loads[[LT::Heating, CLT::Skylights]] = ComponentLoad.new(ems_variable: 'loads_htg_skylights')
    @component_loads[[LT::Heating, CLT::SkylightsTransmitted]] = ComponentLoad.new(ems_variable: 'loads_htg_skylights_transmitted')
    ...
    @component_loads[[LT::Cooling, CLT::WindowsTransmitted]] = ComponentLoad.new(ems_variable: 'loads_clg_windows_transmitted')
    @component_loads[[LT::Cooling, CLT::Skylights]] = ComponentLoad.new(ems_variable: 'loads_clg_skylights')
    @component_loads[[LT::Cooling, CLT::SkylightsTransmitted]] = ComponentLoad.new(ems_variable: 'loads_clg_skylights_transmitted')
