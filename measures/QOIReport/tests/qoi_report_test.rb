...
class QOIReportTest < MiniTest::Test
  ...
  def test_peak_magnitude_timing
    ...
    actual_val = @@measure.timing(timeseries, [-1e9, 1e9], 'max', 1)
  ...
  def test_average_daily_use_base
    ...
    actual_val = @@measure.average_daily_use(timeseries, @@measure.seasons[Constants.SeasonHeating], 'min', 1)
    assert_in_epsilon(5.0, actual_val, 0.001) # average of 0 and 10

    actual_val = @@measure.average_daily_use(timeseries, @@measure.seasons[Constants.SeasonCooling], 'min', 1)
    assert_in_epsilon(9.0, actual_val, 0.001) # average of 8 and 10

    actual_val = @@measure.average_daily_use(timeseries, @@measure.seasons[Constants.SeasonOverlap], 'min', 1)
  ...
  def test_average_daily_use_peak
    ...
    actual_val = @@measure.average_daily_use(timeseries, @@measure.seasons[Constants.SeasonHeating], 'max', 1)
    assert_in_epsilon(11.0, actual_val, 0.001) # average of 10 and 12

    actual_val = @@measure.average_daily_use(timeseries, @@measure.seasons[Constants.SeasonCooling], 'max', 1)
    assert_in_epsilon(13.0, actual_val, 0.001) # average of 10 and 16

    actual_val = @@measure.average_daily_use(timeseries, @@measure.seasons[Constants.SeasonOverlap], 'max', 1)
  ...
  def test_average_daily_timing_base
    ...
    actual_val = @@measure.average_daily_timing(timeseries, @@measure.seasons[Constants.SeasonHeating], 'min', 1)
    assert_in_epsilon(0.0, actual_val, 0.001) # average of 0 and 0

    actual_val = @@measure.average_daily_timing(timeseries, @@measure.seasons[Constants.SeasonCooling], 'min', 1)
    assert_in_epsilon(1.5, actual_val, 0.001) # average of 3 and 0

    actual_val = @@measure.average_daily_timing(timeseries, @@measure.seasons[Constants.SeasonOverlap], 'min', 1)
  ...
  def test_average_daily_timing_peak
    ...
    actual_val = @@measure.average_daily_timing(timeseries, @@measure.seasons[Constants.SeasonHeating], 'max', 1)
    assert_in_epsilon(2.5, actual_val, 0.001) # average of 1 and 4

    actual_val = @@measure.average_daily_timing(timeseries, @@measure.seasons[Constants.SeasonCooling], 'max', 1)
    assert_in_epsilon(6.5, actual_val, 0.001) # average of 0 and 13

    actual_val = @@measure.average_daily_timing(timeseries, @@measure.seasons[Constants.SeasonOverlap], 'max', 1)
