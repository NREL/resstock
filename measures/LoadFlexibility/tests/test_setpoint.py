...
class Testsetpoint(unittest.TestCase):
    ...
    def setup_method(self, method):
        print('setUp')
        state = 'CO'
        on_peak_hour_weekday = pd.read_csv( CURRENT_DIR_PATH / f"on_peak_hour/{state}_weekday_on_peak.csv")
        on_peak_hour_weekend = pd.read_csv(CURRENT_DIR_PATH / f"on_peak_hour/{state}_weekend_on_peak.csv")
