...
class ResilienceMetricsReportTest < MiniTest::Test
  ...
  def test_functionality
    ...
    expected_values = {}
    _test_measure("SFD_Successful_EnergyPlus_Run_TMY_Outages_PV.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, "USA_CO_Denver_Intl_AP_725650_TMY3.epw", 11, 0, 5)
  end
