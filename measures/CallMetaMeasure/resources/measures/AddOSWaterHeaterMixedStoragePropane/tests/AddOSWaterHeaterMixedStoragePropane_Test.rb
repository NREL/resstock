...
class AddOSWaterHeaterMixedStoragePropane_Test < Test::Unit::TestCase

  def setup
    # create an instance of the measure
    @measure = AddOSWaterHeaterMixedStoragePropane.new
  ...
  def test_fifth_argument_is_storage_tank_volume
    ...
    assert_equal "Volume of the Storage Tank (gallons) of the Propane Hot Water Heater. Set to 0 to have Storage tank volume autosized. This field is ignored for NCTH and B10 protocols.", arg.displayName
    refute arg.hasDefaultValue
  ...
  def test_seventh_argument_is_water_heater_location
    ...
    assert_equal "Thermal Zone where the Propane Storage Water Heater is located", arg.displayName
    refute arg.hasDefaultValue
  ...
  def test_eight_argument_is_water_heater_capacity
    ...
    assert_equal "The nominal capacity [kBtu/hr] of the propane storage water heater. Set to 0 to have this field autosized. This field is ignored for NCTH and B10 protocols.", arg.displayName
    refute arg.hasDefaultValue
  ...
  def test_ninth_argument_is_rated_energy_factor
    ...
    assert_equal "Rated Energy Factor of Propane Storage Tank Water Heater. This field is ignored for NCTH and B10 protocols.", arg.displayName
    refute arg.hasDefaultValue
    assert_equal 1, arg.type.value # DoubleArgument
  end
  ...
  def test_eleventh_argument_is_fuel_type
    ...
    assert_includes choices, "Propane"
  end
  ...
  def test_water_heater_capacity_must_be_greater_than_0kW
    assert_error_if_arg_less_than(0, "water_heater_capacity", "Propane Storage Water Heater Nominal Capacity must be greater than 0 kBtu/hr.")
  end
  ...
  def test_water_heater_capacity_of_negative_one_is_an_error
    ...
    errors = @runner.result.errors.collect{ |w| w.logMessage}
    assert_includes errors, "Propane Storage Water Heater Nominal Capacity must be greater than 0 kBtu/hr."
  end
    ...
    assert_error_if_arg_less_than(0,
                                  ...
                                  "Propane Storage Water Heater Recovery Efficiency must be at least 0 and at most 1.")
  end
  ...
  def test_warning_if_rated_energy_factor_too_low
    assert_warning_if_arg_less_than(0.48, "rated_energy_factor",
                                    "Rated Energy Factor for Commercially available Propane Storage Water Heaters should be greater than 0.48")
  end
  
  def test_warning_if_rated_energy_factor_too_high
    assert_warning_if_arg_greater_than(0.82, "rated_energy_factor",
                                    "Rated Energy Factor for Commercially available Propane Storage Water Heaters should be less than 0.82")
  end
  
  def test_water_heater_capacity_should_be_in_sensible_range
    assert_warning_if_arg_less_than(25,"water_heater_capacity",
                                    "Commercially Available Propane Storage Water Heaters should have a minimum Nominal Capacity of 25 kBtu/h.")
    assert_warning_if_arg_greater_than(75,"water_heater_capacity",
                                       "Commercially Available Propane Storage Water Heaters should have a maximum Nominal Capacity of 75 kBtu/h.")
  end
  ...
  def test_water_heater_recovery_efficiency_should_be_in_sensible_range
    assert_warning_if_arg_less_than(0.70, "water_heater_recovery_efficiency",
                                    "Commercially Available Propane Storage Water heaters should have a minimum rated recovery efficiency of 0.70.")
    assert_warning_if_arg_greater_than(0.90, "water_heater_recovery_efficiency",
                                       "Commercially Available Propane Storage Water heaters should have a maximum rated recovery efficiency of 0.90.")
  end
  ...
  def test_water_heater_fuel_is_propane
    ...
    heater = @model.getWaterHeaterMixeds[0]
    assert_equal "Propane", heater.heaterFuelType
  end
  ...
  def test_result_returns_info_messages
    ...
    assert_info_contains "Water heater '#{heater.name.get}' has a heater fuel type of 'Propane'"
