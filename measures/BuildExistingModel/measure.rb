...
class BuildExistingModel < OpenStudio::Measure::ModelMeasure
  ...
  def run(model, runner, user_arguments)
    ...
    (1..num_units_modeled).each do |unit_number|
      ...
      measures['BuildResidentialHPXML'][0]['simulation_control_timestep'] = args[:simulation_control_timestep] if args[:simulation_control_timestep]
      if args[:simulation_control_run_period_begin_month] && args[:simulation_control_run_period_begin_day_of_month] && args[:simulation_control_run_period_end_month] && args[:simulation_control_run_period_end_day_of_month]
      ...
      # Emissions
      if args[:emissions_scenario_names]
      ...
      # Utility Bills
      if args[:utility_bill_scenario_names]
