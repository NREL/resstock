...
class TimeseriesCSVExportTest < MiniTest::Test
  def test_leap_year_timestep_and_subcategories
    ...
    _test_measure("SFD_Successful_EnergyPlus_Run_AMY_PV.osm", args_hash, expected_values, __method__, "0465925_US_CO_Boulder_8013_0-20000-0-72469_40.13_-105.22_NSRDB_2.0.1_AMY_2012.epw", "appliances_schedules_leap.csv", num_output_requests)
  end
  ...
  def test_amy_short_run_period_hourly
    ...
    _test_measure("SFD_Successful_EnergyPlus_Run_AMY_PV_TwoDays.osm", args_hash, expected_values, __method__, "0465925_US_CO_Boulder_8013_0-20000-0-72469_40.13_-105.22_NSRDB_2.0.1_AMY_2014.epw", "appliances_schedules.csv", num_output_requests)
  end
  ...
  def test_tmy_hourly
    ...
    _test_measure("SFD_Successful_EnergyPlus_Run_TMY_Appl_PV.osm", args_hash, expected_values, __method__, "USA_CO_Denver.Intl.AP.725650_TMY3.epw", "appliances_schedules.csv", num_output_requests)
  end
  ...
  def test_tmy_daily_and_subcategories_mf
    ...
    _test_measure("MF_Successful_EnergyPlus_Run_TMY_Appl_PV.osm", args_hash, expected_values, __method__, "USA_CO_Denver.Intl.AP.725650_TMY3.epw", "appliances_schedules.csv", num_output_requests)
  end
