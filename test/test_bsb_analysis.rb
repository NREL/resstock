...
class TesBuildStockBatch < MiniTest::Test
  def before_setup
    ...
    @exclusions = [
      ...
      'report_simulation_output.include_annual_component_loads',
      'report_simulation_output.include_annual_emission_end_uses',
      'report_simulation_output.include_annual_emission_fuels',
      'report_simulation_output.include_annual_emissions',
      'report_simulation_output.include_annual_hot_water_uses',
      'report_simulation_output.include_annual_hvac_summary',
      'report_simulation_output.include_annual_peak_fuels',
      'report_simulation_output.include_annual_peak_loads',
      'report_simulation_output.include_annual_system_use_consumptions',
      'report_simulation_output.include_annual_total_consumptions',
      'report_simulation_output.include_annual_total_loads',
      'report_simulation_output.include_annual_fuel_consumptions',
      'report_simulation_output.include_annual_end_use_consumptions',
      'report_simulation_output.include_annual_unmet_hours',
      ...
      'report_simulation_output.include_timeseries_system_use_consumptions',
