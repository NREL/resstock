...
Open PAT, select "Open Existing Project", and choose the ``project_multifamily_beta`` directory. You may be asked if you want "mongod" to accept incoming connections. Select "Allow".
