...
.. changelog::
    ...
    .. change::
        ...
        **Date**: 2021-03-04
        ...
        The amount of shift is defined in resources/measures/HPXMLtoOpenStudio/resources/schedules/weekday/state_and_monthly_schedule_shift.csv
        and
        resources/measures/HPXMLtoOpenStudio/resources/schedules/weekend/state_and_monthly_schedule_shift.csv
        files.
    ...
    .. change::
        :tags: characteristics, bathrooms, feature
        :pullreq: 601
    ...
    .. change::
        ...
        **Date**: 2021-11-17
        ...
        #[https://github.com/Missing building height dependency in Geometry Wall Type  resstock-estimation#175]
        #[https://github.com/Higher than expected brick %s in wall type in recent vintages resstock-estimation#145] - reverting fix for high brick %s in newer vintages
    ...
    .. change::
        ...
        **Date**: 2021-07-14
        ...
        Description:
        Fixes window-to-wall ratio calculation for facades with doors
    ...
    .. change::
        :tags: characteristics, bathrooms, bugfix
        :pullreq: 601
        ...
        **Date**: 2021-06-10
        ...
        Description:
        Fixes number of bathrooms for single-family attached and multi-family buildings
        This PR makes two changes:
