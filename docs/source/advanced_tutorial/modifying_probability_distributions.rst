...
If creating any new housing characteristics tsv files, refer to the :ref:`refresh-outputs` section for instructions on how to get the sampled options to show up in results files.
