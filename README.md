...
BuildStock, built on the [OpenStudio platform](http://openstudio.net), is a project geared at modeling the existing building stock for, e.g., national, regional, or local analysis, using the [EnergyPlus simulation engine](http://energyplus.net). It consists of ResStock<sup>TM</sup> and ComStock<sup>TM</sup>, sister tools for modeling the residential and commercial building stock, respectively. 
