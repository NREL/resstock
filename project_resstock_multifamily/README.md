...
**Description:** The housing characteristic "Bathroom Spot Vent Hour" is a daily schedule designed to capture bathroom fan ventilation.

**Category:** Hot Water, HVAC, and Ventilation
...
## Ceiling Fan
**Description:** The housing characteristic "Ceiling Fan" describes the usage of ceiling fans in the household and their schedule of use during the weekday, weekend, and seasonal factors.

**Category:** Internal Gains and MELs
...
## Clothes Dryer
**Description:** The housing characteristic "Clothes Dryer" describes the home's clothes dryer by its fuel type, combined energy factor (CEF), usage relative to the national average, and hourly usage schedule for weekdays and weekends.
...
## Clothes Washer
**Description:** The housing characteristic "Clothes Washer" describes a home's clothes washer by different usage levels and standard or EnergyStar clothes washers.
...
## Cooking Range
**Description:** The housing characteristic "Cooking Range" describes the home's cooking range by usage amount, the fuel type, the performance and usage schedule.
...
## Cooling Setpoint
**Description:** The housing characteristic "Cooling Setpoint" describes the cooling setpoint temperature for the homes based on the associated weather file.
...
## Days Shifted
**Description:** The housing characteristic "Days Shifted" allows for the simulation to start on various days of the year for the whole building stock.
...
## Dehumidifier
**Description:** The housing characteristic "Dehumidifier" is used to describe the dehumidifiers in the building stock.
...
## Dishwasher
**Description:** The housing characteristic "Dishwasher" described the dishwashers in the building stock. The dishwashers are described by their electric rating, usage level relative to average, number of place settings that can fit in the dishwasher, and the annual energy guide gas cost.
...
## Door Area
**Description:** The housing characteristic "Door Area" specifies the area of the doors in the house, which is based on standard construction practices for the building stock.
...
## Doors
**Description:** The housing characteristic "Doors" describes the material and U-value of the doors in the building stock.
...
## Ducts
**Description:** The housing characteristic "Ducts" describes the air ducts in the building stock. The ducts are described by their insulation level, air leakage percentage, and whether the ducts are in the conditioned space.
...
## Eaves
**Description:** The housing characteristic "Eaves" describes the eave overhang distance for the houses in the building stock.
...
**Description:** The housing characteristic "Geometry Building Floors" describes the number of building floors for the buildings in the building stock. The number of floors is dependent on the building type, the age of the building, and the size of the building.
...
**Description:** The housing characteristic "Geometry Building Number of Units HL" describes the distribution of multifamily units that are low rise or high rise.
...
**Description:** The housing characteristic "Geometry Building Number of Units MF" describes the distribution number units of a multi-family building in the building stock.
...
**Description:** The housing characteristic "Geometry Building Number of Units MF" describes the distribution number units of a single-family attached building in the building stock.
...
## Geometry Building Type
**Description:** The housing characteristic "Geometry Building Type" describes the distribution of the building stock as different types of buildings classes. These classifications are similar to the RECS definitions, but are not exact.
...
## Geometry Building Type FPL
**Description:** The housing characteristic "Geometry Building Type" describes the distribution of the building stock as different types of buildings classes.
...
**Description:** The housing characteristic "Geometry Building Type RECS to ACS" is a mapping TSV file that converts the RECS building type and maps them to the ACS building types.
...
## Geometry Foundation Type
**Description:** The housing characteristic "Geometry Foundation Type" describes the distribution of different foundation types within the building stock and depends on the location of the building and the building type.
...
## Geometry Garage
**Description:** The housing characteristic "Geometry Garage" describes the presence and size of a garages in the building stock.
...
## Geometry House Size
**Description:** The housing characteristic "Geometry House Size" describes the distribution of the floor area of the houses in the building stock and depends on the location, the age, and type of building.
...
**Description:** The housing characteristic "Geometry Is Multifamily Low Rise" maps the building type to low rise residential buildings, so data can be extracted from low rise buildings only.
...
1. OSM, (<https://www.openstreetmap.org/#map=4/38.01/-95.84>)
	...
	**Remarks:** Data obtained by RadiantLabs. Data not for distribution (http://www.radiantlabs.co/).
...
**Description:** The housing characteristic "Geometry Building Number of Units ACS" describes the distribution number units of a multi-family building in the building stock according to the ACS bins.
...
**Description:** The housing characteristic "Geometry Shared Walls MF" describes the distribution of residential low rise multifamily buildings with shared walls to other units in the multifamily building.
...
**Description:** The housing characteristic "Geometry Shared Walls SFA" describes the distribution of residential low rise single family attached buildings with shared walls to other buildings.
...
**Description:** The housing characteristic "Geometry Unit Stories MF" describes the distribution of the number of stories for units in multifamily buildings.
...
**Description:** The housing characteristic "Geometry Unit Stories SF" describes the distribution of the number of stories for units in single-family buildings.
...
## HVAC System Shared
**Description:** The housing characteristic "HVAC System Shared" describes the distribution of different types of HVAC systems and whether these systems are shared between units for multifamily buildings in the building stock.
...
**Description:** The housing characteristic "HVAC System Heat Pump" describes the distribution of HVAC systems types when the heating and cooling is system is combined.
...
## HVAC System Cooling
**Description:** The housing characteristic "HVAC System Cooling" describes the distribution of different cooling systems and system efficiencies in the buildings of the building stock.
...
1. RECS-2009, (<https://www.eia.gov/consumption/residential/data/2009/>)
	...
	**Remarks:** Why are there distributions for Only Heating Shared. In the HVAC system Is Shared.tsv-there is only a 1s in Neither Share.
...
1. No Data Source Needed
	...
	**Remarks:** Should the last 2 lines be Option=Room? Should line None- Only Cooling be Option=None?
...
**Description:** The housing characteristic "HVAC System Heating Electricity" describes the distribution of electric heating systems in the buildings in the building stock.
...
**Description:** The housing characteristic "HVAC System Heating Fuel Oil" describes the distribution of fuel oil heating systems in the buildings in the building stock.
...
**Description:** The housing characteristic "HVAC System Heating Natural Gas" describes the distribution of natural gas heating systems in the buildings in the building stock.
...
**Description:** The housing characteristic "HVAC System Heating None" describes the distribution of buildings with no heating system in the building stock.
...
**Description:** The housing characteristic "HVAC System Heating Other Fuel" describes the distribution of buildings with heating systems other than Electric, Fuel Oil, Natural Gas, or Propane in the building stock.
...
**Description:** The housing characteristic "HVAC System Heating Propane" describes the distribution of propane heating systems in the buildings in the building stock.
...
## HVAC System Is Shared
**Description:** The housing characteristic "HVAC System Is Shared" described the distribution of the heating and cooling system being shared with another home, business, farm, etc.
...
## HVAC System Is Heat Pump
**Description:** The housing characteristic "HVAC System Is Heat Pump" describes the distribution of HVAC systems are heat pumps (combined heating and cooling).
...
## Heating Fuel
**Description:** The housing characteristic "Heating Fuel" describes the heating fuel type for buildings in the building stock.
...
## Heating Setpoint
**Description:** The housing characteristic "Heating Setpoint" describes the distribution of the heating system setpoints.
...
**Description:** The housing characteristic "Hot Water Distribution" describes the distribution of different types of hot water pipe configurations in the building stock.
...
## Hot Water Fixtures
**Description:** The housing characteristic "Hot Water Fixtures" describes the distribution of different usage levels of showers, sinks, and baths in the building stock.
...
## Infiltration
**Description:** The housing characteristic "Infiltration" describes the distribution of buildings with different levels of infiltration rated at the air changes per hour at 50 Pascals pressure difference from the outdoors (ACH50) with a blower door test.
...
**Description:** The housing characteristic "Insulation Crawlspace" describes the distribution of crawlspace insulation and venting configurations for buildings in the building stock.
...
2. NAHB Survey-1988, (<https://www.nahb.org/>)
	...
	**Remarks:** Purchased Data from National Association of Home Builders. Not for distribution.

3. HIRL-1999, (<http://www.homeinnovation.com/>)

	**Remarks:** Purchased Data from Home Innovation Research Laboratory. Not for distribution.
...
**Description:** The housing characteristic "Insulation Finished Basement" describes the presence and level of insulation in finished basements in the building stock.
...
**Description:** The housing characteristic "Insulation Finished Roof" describes the distribution of the level of insulation for cathedralized roofs.
...
**Description:** The housing characteristic "Insulation Interzonal Floor" describes the insulation level of interzonal floors in the building stock.
...
**Description:** The housing characteristic "Insulation Pier Beam" describes the presence and level of insulation for pier and beam foundations in the building stock.
...
## Insulation Slab
**Description:** The housing characteristic "Insulation Slab" describes the distribution of level and configuration of the insulation in slab foundations in the building stock.
...
**Description:** The housing characteristic "Insulation Unfinished Attic" describes the level of ceiling insulation in attics in the building stock.
...
**Description:** The housing characteristic "Insulation Unfinished Basement" Describes the insulation level and configuration of unfinished basements in the building stock.
...
## Insulation Wall
**Description:** The housing characteristic "Insulation Wall" describes the distribution of the level of insulation in walls in the building stock.
...
## Lighting
**Description:** The housing characteristic "Lighting" describes the distribution of different lightbulbs used in the building stock.
...
1. Expert Elicitation
	...
	**Remarks:** Is there a better source (RECS?)
...
## Location
**Description:** The housing characteristic "Location" describes the distribution of the different building types in each of the Weather file locations.
...
## Location Region
**Description:** The housing characteristic "Location Region" describes the distribution of building within the different U.S. Census Regions.
...
**Description:** The housing characteristic "Location Weather Filename" describes the distribution of the houses in the building stock in different weather regions near the EWP weather file's latitude and longitude.
...
## Location Weather Year
**Description:** The housing characteristic "Location Weather Year" describes the type of weather files used.
...
**Description:** The housing characteristic "Mechanical Ventilation" describes the types of mechanical ventilation used for buildings in the building stock.
...
**Description:** The housing characteristic "Misc Extra Refrigerator" describes the a second refrigerator in buildings in the building stock.
...
## Misc Freezer
**Description:** The housing characteristic "Misc Freezer" describes an additional freezers in buildings in the building stock.
...
## Misc Gas Fireplace
**Description:** The housing characteristic "Misc Gas Fireplace" describes the use of gas fire places in buildings in the building stock.
...
## Misc Gas Grill
**Description:** The housing characteristic "Misc Gas Grill" describes the use of gas grills hooked up to the building's gas line in the building stock.
...
## Misc Gas Lighting
**Description:** The housing characteristic "Misc Gas Lighting" describes the use of gas lighting for buildings in the building stock.
...
## Misc Hot Tub Spa
**Description:** The housing characteristic "Misc Hot Tub Spa" describes the use of hot tubs/spas in buildings in the building stock.
...
## Misc Pool
**Description:** The housing characteristic "Misc Pool" describes the presence of pools on properties in the buildings stock.
...
## Misc Well Pump
**Description:** The housing characteristic "Misc Well Pump" describes the presence and usage of water well pumps for buildings in the building stock.
...
## Natural Ventilation
**Description:** The housing characteristic "Natural Ventilation" describes the frequency in which the building uses natural ventilation to increase the air change rate of buildings in the building stock.
...
## Occupants
**Description:** The housing characteristic "Occupants" describes the number of occupants, size of the internal gains, and occupancy schedules for occupants in the building stock.
...
## Orientation
**Description:** The housing characteristic "Orientation" describes the distribution of orientation of buildings in the building stock.
...
## Overhangs
**Description:** The housing characteristic "Overhangs" describes the distribution and use of overhangs for windows shading on different sides of buildings in the building stock.
...
## PV
**Description:** The housing characteristic "PV" describes the use of photovoltaic modules for buildings in the building stock.
...
## Plug Loads
**Description:** The housing characteristic "Plug Loads" describe the distribution of different usage levels of AC electrical plug loads for buildings in the buildings stock.
...
**Description:** The housing characteristic "Range Spot Vent Hour" describes the distribution of when range ventilation is used during cooking for buildings in the building stock.
...
## Refrigerator
**Description:** The housing characteristic "Refrigerator" describes the usage, performance, and schedules of the primary refrigerator for buildings in the building stock.
...
1. RECS-2009, (<https://www.eia.gov/consumption/residential/data/2009/>)
	...
	**Remarks:** How is the energy factor (EF) calculated and how do you translate michaelbluejay.com table data to efficiency?
...
## Roof Material
**Description:** The housing characteristic "Roof Material" describes the distribution of roofing materials and their thermal properties for buildings in the building stock.
...
## Solar Hot Water
**Description:** The housing characteristic "Solar Hot Water" describes the solar heating hot water system for buildings in the building stock.
...
## Usage Level
**Description:** The housing characteristic "Usage Level" describes the distribution of the population that are High, Medium, and High users of appliances, plug loads, and MELs.
...
## Vintage
**Description:** The housing characteristic "Vintage" describes the distribution of when building were built in the building stock.
...
## Vintage FPL
**Description:** The housing characteristic "Vintage FPL" describes the distribution of when building were built in the building stock. The ACS indicates the data comes from ACS.
...
## Water Heater
**Description:** The housing characteristic "Water Heater" describes the distribution of different types of water heaters and heating fuel types in the building stock.
...
## Window Areas
**Description:** The housing characteristic "Window Areas" describes the window-wall-ratio (WWR) distributions for the front, back, left, and right sides of buildings in the building stock.
...
## Windows
**Description:** The housing characteristic "Windows" describes the distribution of single pane, double pane, or no windows for buildings in the building stock.
