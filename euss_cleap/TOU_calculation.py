...
def main(community, monthly_fixed_charge):
    ...
    community_results['pct_saving_cbill.total_%'] = community_results['saving_cbill.total_usd']/community_results['baseline_cbill.total_usd'] * 100
...
main('columbia', 13) # community name and monthly fixed fee