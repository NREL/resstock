...
def main(community):
    ...
    community_results['baseline_cbill.total_usd'] =\
        community_results['baseline_cbill.electricity__tiered__usd'].fillna(0) +\
        community_results['baseline_cbill.natural_gas__tiered__usd'].fillna(0) +\
    ...
    community_results['saving_cbill.total_usd'] =\
        community_results['saving_cbill.electricity_tiered_usd'].fillna(0) +\
        community_results['saving_cbill.natural_gas_tiered_usd'].fillna(0) +\
