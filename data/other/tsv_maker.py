...
projects = ['project_singlefamilydetached', 'project_multifamily_beta']
...
class OtherSources(TSVMaker):
    ...
    def lighting(self):
        ...
        cols = ['Option=100% Incandescent', 'Option=100% CFL',
                'Option=100% LED', 'sample_count', 'sample_weight']
        ...
        self.df.loc[0, cols] = [0.516, 0.414, 0.07, 0.0, 0.0]

        # Set name of housing characteristic
        option_col = 'Lighting'

        # Write and copy the file
        for project in projects:
            lighting = self.df.copy()
