...
cols = ['MTUE002', 'MTUM002', 'MTXE002', 'MTXE003', 'MTXE004', 'MTXE005', 'MTXE006', 'MTXE007', 'MTXE008', 'MTXE009', 'MTXE010', 'MTXM002', 'MTXM003', 'MTXM004', 'MTXM005', 'MTXM006', 'MTXM007', 'MTXM008', 'MTXM009', 'MTXM010',
        'MP0E002', 'MP0E003', 'MP0E004', 'MP0E005', 'MP0E006', 'MP0E007', 'MP0E008', 'MP0E009', 'MP0E010', 'MP0E011', 'MP0E012', 'MP0E013', 'MP0E014', 'MP0E015', 'MP0E016', 'MP0E017', 'MP0M002', 'MP0M003', 'MP0M004', 'MP0M005', 'MP0M006', 'MP0M007', 'MP0M008', 'MP0M009', 'MP0M010', 'MP0M011', 'MP0M012', 'MP0M013', 'MP0M014', 'MP0M015', 'MP0M016', 'MP0M017']
...
def retrieve_data():
  ...
  if not len(pkls) > 0:
    ...
    # sql = """SELECT * FROM acs_2011.acs_tract_5yr limit 1000;"""
    sql = """SELECT * FROM acs_2011.acs_tract_5yr;""" # 74,001
    positions = [retrieve_data_headers(con).index(x) for x in cols]
    for i, df in enumerate(pd.read_sql(sql, con, chunksize=100)):
